...
> **Stato del progetto:** Questo progetto è ancora in corso e in fase di implementazione.

---

## Strumenti

Le tecnologie e software che ho deciso di utilizzare per questa demo sono le seguenti:

Per sviluppare la web app ho utilizzato tre software per l’implementazione:

| Componente | Tecnologia / Software |
| :--- | :--- |
| **Database** | SQL Server |
| **Back End** | Visual Studio *(Linguaggio: C# \| Framework: .NET 8)* |
| **Front End** | Visual Studio Code *(Angular V21, Signal Store, CSS Tailwind)* |
